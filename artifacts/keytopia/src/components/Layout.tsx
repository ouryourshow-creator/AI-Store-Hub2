    ...
    <div className="min-h-[100dvh] flex flex-col bg-background" dir={dir}>
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-black/[0.03]">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between gap-5">
          <Link href="/" className="flex h-12 w-32 sm:h-14 sm:w-44 items-center overflow-hidden select-none">
            <img
              src={logoImg}
              alt="Keytopia"
              className="h-36 sm:h-44 w-auto max-w-none shrink-0 object-contain"
            />
          </Link>
      ...
      {!location.startsWith('/checkout') && <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-6 start-6 z-40 flex items-center gap-3 px-5 py-3 rounded-full bg-[#25D366] shadow-lg hover:bg-[#20c35e] hover:scale-105 active:scale-95 transition-all"
      >
